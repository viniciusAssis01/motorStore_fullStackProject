      ...
      <div className="flex flex-col w-full gap-4">
        <div className="flex items-center gap-2">
          <div className="flex w-full gap-2">
            <div className={`rounded-full w-8 h-8 flex items-center justify-center ${colorOptions[commentUser.color!]}`}>
              <p className="font-medium w-max text-grey-10">{getUserAcronym(commentUser.name!)}</p>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-[12px] text-grey-3">{calcTimePassed(comment.createdAt)}</p>
            </div>
          </div>
